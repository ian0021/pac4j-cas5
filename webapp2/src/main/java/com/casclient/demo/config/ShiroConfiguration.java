...
import com.casclient.demo.config.CustomPac4jRealm;
...
public class ShiroConfiguration extends AbstractShiroWebFilterConfiguration {
    ...
    @Bean
    public DirectCasProxyClient directCasProxyClient(CasConfiguration config) {
        DirectCasProxyClient directCasProxyClient = new DirectCasProxyClient(config, casClientPrefixUrl);
        directCasProxyClient.setName("casproxy");
     ...
     */
    @Bean
    protected Clients clients(CasClient casClient, DirectCasProxyClient directCasProxyClient) {
        //可以设置默认client
        Clients clients = new Clients();
        clients.setClients(casClient, directCasProxyClient);
    ...
    protected ShiroFilterFactoryBean shiroFilterFactoryBean(DefaultWebSecurityManager securityManager, Config config) {
        ...
        securityFilter.setClients("cas, casproxy");
